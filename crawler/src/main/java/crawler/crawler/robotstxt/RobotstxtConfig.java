...
package crawler.crawler.robotstxt;
...
public class RobotstxtConfig {
     ...
     */
    private String userAgentName = "Mozilla/5.0 (compatible; Ask Jeeves/Teoma; +http://about.ask.com/en/docs/about/webmasters.shtml)";
